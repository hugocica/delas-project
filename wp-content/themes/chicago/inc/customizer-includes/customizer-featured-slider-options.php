 ...
 */
	...
	$featured_slider_content_options = chicago_featured_slider_options();
	$choices = array();
	...
	$chicago_featured_slide_transition_effects = chicago_featured_slide_transition_effects();
	$choices = array();
	foreach ( $chicago_featured_slide_transition_effects as $chicago_featured_slide_transition_effect ) {
		$choices[$chicago_featured_slide_transition_effect['value']] = $chicago_featured_slide_transition_effect['label'];
	}
	...
	$featured_slider_image_loader_options = chicago_featured_slider_image_loader();
	$choices = array();
	...
	$featured_slider_types = chicago_featured_slider_types();
	$choices = array();
