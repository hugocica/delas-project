 ...
 */
function chicago_sanitize_checkbox( $checked ) {
    // Boolean check.
 ...
 * @since  Chicago 1.1
 */
function chicago_sanitize_custom_css( $input ) {
	if ( $input != '' ) { 
 ...
 */
function chicago_sanitize_image( $image, $setting ) {
	/*
 ...
 */
function chicago_sanitize_page( $input ) {
 ...
 * @since Chicago 1.1
 */
function chicago_sanitize_category_list( $input ) {
	if ( $input != '' ) { 
		$args = array(
						'type'			=> 'post',
						'child_of'      => 0,
 ...
 *                    the setting default.
 */
function chicago_sanitize_number_range( $number, $setting ) {
 ...
 */
function chicago_sanitize_select( $input, $setting ) {
 ...
 */
function chicago_sanitize_important_link() {
	return false;
}
 ...
 * @since  Chicago 1.1
 */
function chicago_reset_all_settings( $input ) {
	if ( $input == 1 ) {
